...
exports.add = function(data,callback){
    var sql = 'insert into taoyitu(' +
        ...
        'WeekRateNormal,YearOldRateBad,YearOldRateGood,YearOldRateNormal,YearRateBad,YearRateGood,YearRateNormal,LastUpdate,UserIdent,UserIdentImg) values(' +
        '?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
    model.execute(sql,[
        data.IsSeller,
        data.ModelState,
...
exports.save = function(data,callback){
    var sql = 'update taoyitu set ' +
        ...
        'ShopType=?,ShopUrl=?,TotalRateBadCount=?,TotalRateNormalCount=?,UserArea=?,UserBuyerCount=?,UserBuyerGoodRate=?,UserBuyerImg=?,' +
        'UserName=?,UserRateUrl=?,UserSellerCount=?,UserSellerGoodRate=?,UserSellerImg=?,UserTime=?,WeekRateBad=?,WeekRateGood=?,' +
        'WeekRateNormal=?,YearOldRateBad=?,YearOldRateGood=?,YearOldRateNormal=?,YearRateBad=?,YearRateGood=?,YearRateNormal=?,LastUpdate=?,UserIdent=?,UserIdentImg=? where id=?';
    model.execute(sql,[
        data.IsSeller,
        data.ModelState,
        data.MonthRateBad,
